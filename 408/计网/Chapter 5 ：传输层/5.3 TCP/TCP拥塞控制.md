...
拥塞控制与流量控制的区别：  
**拥塞控制**的目标是使网络能够承受当前的负载，是一个**全局性**过程，涉及所有主机、路由器及影响网络性能的各种因素。而**流量控制**则关注点对点通信中接收方的处理能力，是一个**端到端**的问题，由接收方通过窗口机制抑制发送方的发送速率，以确保自身能及时接收数据。尽管二者目标不同，但都是通过调节发送方的发送速率来实现控制效果的。
